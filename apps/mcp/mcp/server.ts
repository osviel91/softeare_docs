...
8. For complementary projections, call list_resource_relationships before authoring and create_resource_relationship when the typed relationship is absent. Prose such as "complements X" in a description is not a replacement for a typed relationship.
