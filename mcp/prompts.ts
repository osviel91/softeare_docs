        ...
        messages: [
          userMessage(
            [
              ...
              "2. Classify needs as business flows, real asynchronous event contexts, Notes, or unsupported Conceptual/Database gaps. HTTP requests, synchronous calls, proxy routing, cron, logs/telemetry, and infrastructure topology do not establish an Event Flow; no asynchronous event context is a valid result. Do not force unsupported or synchronous behavior into available types.",
        ...
        messages: [
          userMessage(
            [
              ...
              "- When real asynchronous behavior exists, use Event -> handler/consumer -> effects -> resulting events as an investigation heuristic, not a mandatory graph. Use current syntax only; put unsupported handler/effect details in honest annotations or report the gap.",
              "",
