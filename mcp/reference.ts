...
export const SERVER_INSTRUCTIONS = [
  ...
  "2. Classify each need: Sequence is one business/application flow; Event Flow represents asynchronous/event-driven causal behavior; Markdown is a Note for cross-cutting rules and context. HTTP requests, synchronous calls, reverse-proxy routing, cron invocation, logs/telemetry, and infrastructure topology do not establish an Event Flow by themselves. A project may legitimately have no Event Flow documentation; do not force synchronous or structural behavior into it. Conceptual (structure) and Database (persistence) are future, unsupported representations; report those gaps instead of misusing another type.",
