...
export const SERVER_INSTRUCTIONS = [
  ...
  "Conventions that make the output good:",
   ...
   "- Sequence semantic messages are explicit local occurrences: use `semantic event|command publish|consume|dispatch Name` only when evidence supports it. Do not infer from suffixes or brokers, and do not create a complementary-view relationship merely because an Event Flow uses the same display name.",
